...
E 			: E '+' E
			...
			| E LOGICA E
			{
                ...
                $$.label = label;
                $$.tipo = opAritmetico[tipoToIndice($1.tipo)][tipoToIndice($3.tipo)];
                string logica = $2.traducao;
...
LOGICA		: TK_MENOR_IGUAL { $$.traducao = "<="; }
			| TK_MAIOR_IGUAL { $$.traducao = ">="; }
			| TK_OU 		 { $$.traducao = "||"; }
			| TK_E 			 { $$.traducao = "&&"; }
			| TK_IGUAL 		 { $$.traducao = "=="; }
			| TK_DIFERENTE 	 { $$.traducao = "!="; }
			| TK_MENOR 		 { $$.traducao = "<"; }
			| TK_MAIOR 		 { $$.traducao = ">"; }
			;
